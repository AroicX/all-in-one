<div class="modal fade modal-default" id="edit-management" tabindex="-1" role="dialog" aria-labelledby="addManagerModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="{{url('corpemt/engagement/editmanagement')}}" class="form-horizontal">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user"></i> Edit Management</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="fullname" class="form-control" id="m-fullname">
                                </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea class="form-control" name="discuss" id="discuss"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="management_id" id="management-id">
