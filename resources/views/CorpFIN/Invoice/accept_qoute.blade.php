                ...
                <div>
                    <div class="card">
                      <div class="col-md-12">
                        ...
                        <a href="{{ url('') }}/client/invoice/quote/view/{{ \Crypt::encrypt($invoice->id)}}"  class="btn btn-primary">View Invoice</a>
                        @else
                        <a href="{{ url('') }}/client/invoice/quote/view/{{ \Crypt::encrypt($invoice->id)}}"  class="btn btn-primary">Proceed to Payment</a>
                        @endif
                        </div>
                    </div>
                  </div>
