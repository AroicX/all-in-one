    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form class="row" action="{{route('corphrm.leaveallowanceform')}}" method="post" id="payment_form">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="number" name="allowance_percent" id="allowance_percent" class="form-control"
                                required="required">
                        </div>
