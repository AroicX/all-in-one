		...
		<div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                	...
                	<div class="card-body">
                            <form class="row" action="{{route('corphrm.loanmasterform')}}" method="post">
                		<div class="form-group col-sm-6">
                                    <label for="loan_name">Loan Name</label>
                                    <input type="text" name="loan_name" class="form-control" required="required">
                                </div>

                                <div class="form-group col-sm-6">
                                    <label for="loan_maximum_limit">Loan Maximum Limit</label>
                                    <input type="text" name="loan_maximum_limit" class="form-control" required="required">
                                </div>
                                
                                <div class="form-group col-sm-6">
                                    <label for="loan_annual_gross">Loan Limit % on Annal gross</label>
                                    <input type="text" name="loan_annual_gross" class="form-control" required="required">
                                </div>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="allow_multiple_loan" id="optionsRadiosInline2" value="0" checked>No
                                    </label>
                                </div>
