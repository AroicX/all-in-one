    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="text-align:center;">List of details given to Applicant!</h4>
            </div>
...
<hr>
  <div class="col-md-12">
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="{{$app['name']}}" name="fname" required="" readonly="">
    </div>
  </div>
...
<div class="col-md-6">
  <div class="form-group">
    ...
    <select class="form-control" name="alias"  required="" readonly="">
     <option @if($app['alias'] == "Mr") selected="selected" @endif value="Mr">Mr</option>
     <option @if($app['alias'] == "Mrs") selected="selected" @endif value="Mrs">Mrs</option>
     <option @if($app['alias'] == "Miss") selected="selected" @endif value="Miss">Miss</option> 
    </select>
  </div>
</div>
<div class="col-md-6">
  <div class="form-group">
    ...
    <select class="form-control" name="marital_status" required="" readonly="">
     <option @if($app['marital_status'] == "Single") selected="selected" @endif value="Single">Single</option>
     <option @if($app['marital_status'] == "Married") selected="selected" @endif value="Married">Married</option>
    </select>
  </div>
</div>
    <div class="col-md-6">
    <div class="form-group">
      ...
      <input type="number" value="{{$app['age']}}" class="form-control" name="age" required="" readonly="">
    </div>
  </div>
    <div class="col-md-6">
    <div class="form-group">
      <label>Qualifications<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['qualification']}}" class="form-control" name="qualification" readonly="" placeholder="Bsc., Msc., HND, Phd ..." required="">
    </div>
  </div>
      <div class="col-md-6">
    <div class="form-group">
      <label>Address<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['address']}}" class="form-control" name="address" required="" readonly="">
    </div>
  </div>
      <div class="col-md-6">
    <div class="form-group">
      <label>City<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['city']}}" class="form-control" name="city" required="" readonly="">
    </div>
  </div>
      <div class="col-md-6">
    <div class="form-group">
      <label>State<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['state']}}" class="form-control" name="state" required="" readonly="">
    </div>
  </div>
      <div class="col-md-6">
    <div class="form-group">
      <label>Country<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['country']}}" class="form-control" name="country" required="" readonly="">
    </div>
  </div>
        <div class="col-md-6">
    <div class="form-group">
      <label>Email<span style="color: red;">*</span></label>
      <input type="email" value="{{$app['email']}}" class="form-control" name="email" required="" readonly="">
    </div>
  </div>
        <div class="col-md-6">
    <div class="form-group">
      <label>Phone Number<span style="color: red;">*</span></label>
      <input type="text" value="{{$app['phone']}}" class="form-control" name="phone" required="" readonly="">
    </div>
  </div>
...
<hr>
    ...
    <div class="form-group">
      ...
      <a href="{{$app['cv_file']}}">View</a>
    </div>
  </div>
      <div class="col-md-6">
    <div class="form-group">
      <label>Other Files </label>
<a href="{{$app['other_file']}}">View</a>
    </div>
  </div>
  </div>
...
<hr>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="{{$app['last_employer']}}" name="last_employer" readonly="">
    </div>
  </div>
          <div class="col-md-6">
    <div class="form-group">
      <label>Last Salary</label>
      <input type="text" class="form-control" value="{{$app['last_salary']}}" name="last_salary" readonly="">
    </div>
  </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="nature_of_employment" readonly="">{{$app['nature_of_employment']}}</textarea>
    </div>
  </div>
</div>
...
<hr>
    ...
    <div class="form-group">
      <label>Comment</label>
      <textarea class="form-control" name="Comment" readonly="">{{$app['comment']}}</textarea>
    </div>
  </div>
</div>
